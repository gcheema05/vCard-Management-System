...
// A function to create and validate a vCard file
int createAndValidate (char * fileName);

// A function to create, validate, and return a string of the following format: 'contact;bday;ann;otherPropLen'
char * createValidateStr (char * fileName);

// A function to edit FN property of existing vCard file or create a new file using given fileName and fn value
int editFN (char * fileName, char * fn); 

// A function to create a new file with the given name and fn property
